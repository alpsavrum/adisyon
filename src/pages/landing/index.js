  ...
  return (
    <div>
      <section className="restaurants-header">
        ...
        <img src="assets/logos/transparent.svg" alt="triangle with all three sides equal" width="500" />
        <Typography variant="h4">Yemekse derdin, Adisyon önersin!</Typography>
        <Typography variant="h6">Adisyon, açık kaynak bir restoran-menü öneri motorudur.</Typography>
